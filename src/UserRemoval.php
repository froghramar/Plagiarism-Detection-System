...
$students = "DELETE FROM Student WHERE Email = '$email'";
$teachers = "DELETE FROM Teacher WHERE Email = '$email'";
$admins = "DELETE FROM Admin WHERE Email = '$email'";
$forms = "DELETE FROM Form WHERE Email = '$email'";
...
echo "<div class='container'>";
  ...
  echo "<div class='alert alert-success'>";
    echo "<strong>Success!</strong> User with the provided email had been removed.";
  echo "</div>";
echo "</div>";
