...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="RemoveUser.php" title="Remove An User Account"><span class="glyphicon glyphicon-trash"></span> Remove User</a></li>
				</ul>
	...
	<div class="container">
		<h3>Remove An User Account</h3>
		<form role="form" action="UserRemoval.php" method="post">
