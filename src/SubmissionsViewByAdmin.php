	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="SubmissionsViewByAdmin.php" title="All Submissions"><span class="glyphicon glyphicon-send"></span> Submissions</a></li>
				</ul>
				<ul class="nav navbar-nav">
		  ...
		  echo "<table class='table'>";
			...
			while($row = $result->fetch_assoc()){
				...
				echo "<tr>";
		      		...
		      		echo "<td>$course</td>";
		      		echo "<td>$title</td>";
		      		if($status == 'Accepted') echo "<td style='color: #33cc33'>Accepted</td>";
		      		else if($status == 'Rejected') echo "<td style='color: #cc3300'>Rejected</td>";
		      		else echo "<td style='color: #003399'>Considerable</td>";
