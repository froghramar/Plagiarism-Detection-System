	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav">
					<li class="active"><a href="Requests.php" title="All Sign Up Requests"><span class="glyphicon glyphicon-user"></span> Requests</a></li>
				</ul>
				<ul class="nav navbar-nav">
			...
			echo "<div class='panel panel-default'>";
				echo "<div class='panel-heading'>";
					...
					echo "<ul class='nav navbar-nav navbar-right'>";
						$VERIFY = "VerifyRequest.php?email=".$email;
						$IGNORE = "IgnoreRequest.php?email=".$email;
						echo "<a style='padding-right: 5px; color: green' href=$VERIFY>verify</a>";
						echo "<a style='color: blue' href=$IGNORE>ignore</a>";
			      	echo "</ul>";
					echo "</h4>";
				echo "</div>";
